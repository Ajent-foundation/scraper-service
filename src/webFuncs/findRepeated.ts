...
// columns
export async function findRepeated(
    ...
    function getMatchingElements(specs) {
        ...
        const allElements = document.querySelectorAll(cleanClassString(query));
 ...
 */
    ...
    for(var i = 0; i < elements.length; i++) {
        ...
        var specs = getElementProperties(element, sampleSpecs);
       ...
       /*  for (var j = 0; j < matchingElements.length; j++) {
        ...
        if(i == 0) {
            ...
            var matchingElements = getMatchingElements(specs);
            ...
            // ignore elements[1] since that is just the reference to identify the list and is already covered with elements[0]
